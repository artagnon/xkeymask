...
%%
%% This Current Maintainer of this work is Ramkumar Ramachandra.
%%
%% This work consists of the file xkeymask.sty.
%%
%% The following files constitute the xkeymask bundle and must be
%% distributed as a whole: README, xkeymask.pdf, xkeymask.sty.
%%
